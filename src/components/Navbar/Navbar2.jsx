...
const Navbar2 = (props) => {
  ...
  return (
    <div className='flex max-w-[1194px] mx-auto font-lato text-[20px] text-logo_color justify-between pt-[50px] px-[5%]'>
        ...
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfphrZml6m60mU1S7_qIJUWObAhHLxj0vx-xA1yvv76PeuQgg/viewform" target="_blank" className={`max-md:hidden group relative flex items-center justify-center w-[147px] h-[54px] bg-${props.colour} rounded-[40px] transition-all duration-[250ms] ease-out overflow-hidden`}>
        ...
        <div className={`fixed top-0 left-0 flex flex-col z-40 justify-center items-center bg-black w-screen transition-[height] md:hidden	${isActive ? 'z-40 h-screen transition-[height]' : 'h-0'}`}>
          <div className='fixed left-[7%] top-[60px]'>
            ...
            <div className={`fixed bottom-[50px]`}>
              <a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSfphrZml6m60mU1S7_qIJUWObAhHLxj0vx-xA1yvv76PeuQgg/viewform" className={`group flex items-center justify-center  h-[54px] bg-white ease-out overflow-hidden ${isActive ? 'transition-all w-[90vw] delay-[125ms]' : 'w-0'}`}>
