    ...
    return (
      ...
      <div className="nav-links space-x-10 text-lg flex lg:ml-[22%] mr-auto">
        <Link className={`${currentPage==='home' ? 'pointer-events-none opacity-60' : ''} ml-[2.5rem] mr-auto group transition-all duration-100 ease-in-out hover:text-[#5CB841] flex no-underline text-[#5d7164] justify-center items-center px-2.5 py-[13px]`} to="/">
          ...
          <Link className="lg: hidden group transition-all duration-100 ease-in-out hover:text-[#5CB841] no-underline text-[#5d7164] justify-center items-center px-2.5 py-[13px]" to="https://docs.google.com/forms/d/e/1FAIpQLSfphrZml6m60mU1S7_qIJUWObAhHLxj0vx-xA1yvv76PeuQgg/viewform" target='_blank'>
      ...
      {visible &&
        <div className='transition-all duration-700'>
          ...
          <div className="flex flex-col w-[350px] h-auto absolute top-28 right-16 bg-slate-100 rounded-2xl text-center z-20 transition-all duration-700">
            <div className="p-4">
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSfphrZml6m60mU1S7_qIJUWObAhHLxj0vx-xA1yvv76PeuQgg/viewform" target="_blank" className="hover:text-[#9db394] active:text-[#a0c48f]">Market & Trends Analyst Applications</a>
            </div>
            <div className="pb-4">
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSfphrZml6m60mU1S7_qIJUWObAhHLxj0vx-xA1yvv76PeuQgg/viewform" target="_blank" className="hover:text-[#95aa8b] active:text-[#a0c48f]">Investment Analyst Application</a>
            </div>
          </div>
        </div>
      }
