...
const Pitches = () => {
    ...
    const getPitchImages = async() => {
      console.log("nevada")
      let responseImg = await fetch('https://web-production-1acdf.up.railway.app/api/pitch/img/');
    ...
    const getPitches = async() => {
      let response = await fetch('https://web-production-1acdf.up.railway.app/api/pitch/');
