...
const Reports = () => {
  ...
  const getReportImages = async() => {
    let responseImg = await fetch('https://web-production-1acdf.up.railway.app/api/report/img/');
  ...
  const getReports = async() => {
    let response = await fetch('https://web-production-1acdf.up.railway.app/api/report/');
